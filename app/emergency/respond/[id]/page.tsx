    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading emergency alert...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="p-8 max-w-md w-full mx-4">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Emergency Alert Not Found</h1>
        ...
        {!isExpired && !isFulfilled && (
          <Card className="p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                {responding ? 'Responding...' : 'Yes, I Can Help'}
              </Button>
              <Button
              ...
              >
                {responding ? 'Responding...' : 'Cannot Help Right Now'}
              </Button>
            </div>
            <p className="text-center text-sm text-gray-600 mt-4">
              Your response helps us coordinate the emergency response effectively.
            </p>
          </Card>
        )}
